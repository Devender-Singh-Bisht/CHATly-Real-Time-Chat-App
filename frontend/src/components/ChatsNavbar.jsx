    ...
    return (
        ...
        <nav>
            <aside className={styles.iconNav}>
                ...
                <div
                    className={`${styles.navIcon} ${activeNav === "chats" ? styles.active : ""}`}
                ...
                <div
                    className={`${styles.navIcon} ${activeNav === "notifications" ? styles.active : ""}`}
                ...
                <div
                    className={`${styles.navIcon} ${activeNav === "friends" ? styles.active : ""}`}
                ...
                <div
                    className={`${styles.navIcon} ${activeNav === "profile" ? styles.active : ""}`}
                ...
                {/* <div
                    className={`${styles.navIcon} ${activeNav === "settings" ? styles.active : ""}`}
