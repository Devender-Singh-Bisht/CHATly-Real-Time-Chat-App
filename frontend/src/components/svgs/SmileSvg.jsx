    ...
    return (
        ...
        >
            ...
            <g transform="matrix(1.5625 0 0 1.5625 37.5 110.94)">
                <path
                    d="M40.77 31C24.27 31 5.8 21.8 4 1.63A1.4 1.4 0 0 1 5.21.07a1.38 1.38 0 0 1 1.55 1.21c1.6 18.47 18.74 26.89 34 26.89 21.58 0 32.38-13.53 33.52-26.89A1.38 1.38 0 0 1 75.73 0 1.45 1.45 0 0 1 77 1.47C75.34 21.84 57.08 31 40.8 31h-.03Z"
                    fill="#000"
                />
            </g>
            ...
            <g transform="matrix(1.5625 0 0 1.5625 31.25 59.38)">
                ...
                />
                <path
                    d="M9.8 9.53a2.29 2.29 0 1 0 0-4.57 2.29 2.28 0 0 0 0 4.57Z"
                    fill="#fff"
                />
                <path
